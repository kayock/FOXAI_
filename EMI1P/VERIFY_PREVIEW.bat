...
cd /d "%~dp0"
title FOXAI Extension Manager Inventory Phase 1 Exact Preview
...
echo.
echo FOXAI EXTENSION MANAGER
echo INVENTORY AND HEALTH DASHBOARD
...
if not defined PY (
  ...
  echo Extract the complete EMI1P folder directly inside Z:\FOXAI.
  pause
  exit /b 1
)
