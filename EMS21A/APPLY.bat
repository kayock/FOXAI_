...
cd /d "%~dp0"
title FOXAI Extension Manager Operator Clarity Phase 2.1
...
if not defined PY (
  ...
  echo Extract the complete EMS21A folder directly inside Z:\FOXAI.
  pause
  exit /b 1
)
...
echo This source apply does not alter extension enable/disable state.
