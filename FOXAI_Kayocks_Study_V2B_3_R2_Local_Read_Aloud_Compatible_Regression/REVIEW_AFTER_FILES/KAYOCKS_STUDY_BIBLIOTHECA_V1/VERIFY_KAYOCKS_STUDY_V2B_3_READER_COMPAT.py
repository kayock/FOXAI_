...
def load_module(path: Path):
    spec = importlib.util.spec_from_file_location("kayocks_study_v2b_3_reader_compat_live", path)
...
def main() -> int:
    ...
    check("version_2b_3_reader_compatible", module.APP_VERSION == "2B.3", module.APP_VERSION)
    ...
    receipt = {
        "schema": "foxai.kayocks_study.v2b_3.reader_compat.verification.v1",
        "mission": "Kayock's Study V2B.3 R2 — Compatible Native Reader Regression",
        "result": "verified",
