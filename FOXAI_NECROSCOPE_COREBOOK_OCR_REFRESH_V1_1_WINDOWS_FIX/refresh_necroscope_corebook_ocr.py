...
def main() -> int:
    ...
    try:
        ...
        try:
            ...
            cleanup_note = "Temporary build file removed."
        except PermissionError:
            cleanup_note = (
                "Temporary build file remains because Windows still had a brief "
                "file lock. It is not the live database and may be removed after "
                "this process closes."
            )
