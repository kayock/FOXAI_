...
$receipt = [ordered]@{
    action = 'foxai_pdr3b_r2_fix1_usb_root_shortcut_contract_readonly_probe'
    created = $created
...
$report.Add('# FOXAI Portable Desktop Runtime Phase 3B-R2-FIX1')
...
Write-Host ""
Write-Host "Phase 3B-R2-FIX1 read-only probe complete."
