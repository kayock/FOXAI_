...
## Overall state: **NEEDS_ATTENTION**

- Critical failures: **1**
- Notes: **8**
- Elapsed seconds: **4.12**
...
- **combined_startup_backend** — The current ComfyUI host-Python/torch backend failed its import probe.
