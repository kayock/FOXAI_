...
title Roll Back FOXAI Poem Selection Workshop v1

for %%I in ("%~dp0..") do set "FOXAI_ROOT=%%~fI"
set "LATEST=%FOXAI_ROOT%\Backups\PoemSelectionWorkshopV1\LATEST.txt"

if not exist "%LATEST%" (
    echo No recorded workshop backup was found.
    pause
    exit /b 2
)
