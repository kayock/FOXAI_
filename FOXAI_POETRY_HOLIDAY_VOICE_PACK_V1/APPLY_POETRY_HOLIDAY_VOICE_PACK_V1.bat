...
title FOXAI Poetry Holiday Voice Pack V1
...
echo ============================================================
echo FOXAI POETRY HOLIDAY VOICE PACK V1
echo ============================================================
echo Adds:
...
echo.
echo Preserves:
echo   Eric - Poet/Narrator
echo   Rhyme and Rhythm Coach
echo   Guarded stanza alternatives
echo   My Poems and Open Poem Project
echo.
...
if not exist "%PAYLOAD%" (
    echo ERROR: Voice-pack payload is missing.
    pause
    exit /b 4
)
if not exist "%PYTHON%" (
...
echo ============================================================
echo Restart FOXAI WebUI, open Poetry Studio, and use the Voice menu.
echo.
pause
exit /b 0
...
:apply_failed
echo ERROR: Copy failed. Restoring the backup...
goto :rollback
