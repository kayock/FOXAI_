...
title Roll Back FOXAI Poetry Studio v1 UX Cleanup

for %%I in ("%~dp0..") do set "FOXAI_ROOT=%%~fI"
set "LATEST=%FOXAI_ROOT%\Backups\PoetryStudioV1UXCleanup\LATEST.txt"

if not exist "%LATEST%" (
    echo No recorded Poetry Studio UX backup was found.
    pause
    exit /b 2
)
