...
def load_module(path: Path):
    spec = importlib.util.spec_from_file_location("kayocks_study_v2c_1_1_reader_regression_live", path)
...
def main() -> int:
    ...
    check("version_2c_1_1_reader_compatible", module.APP_VERSION == "2C.1.1", module.APP_VERSION)
    ...
    check("reader_regression_allows_local_narration_without_external_tts_libraries", all(token not in source for token in ("pyttsx3", "sapi.SpVoice", "edge_tts", "api.openai.com/v1/audio")))
    ...
    required_ui = (
        ...
        "Start from Beginning", "Add Bookmark", "Continue Reading", "Read This to Me",
    ...
    receipt = {
        "schema": "foxai.kayocks_study.v2c_1_1.reader_regression.verification.v1",
        "mission": "Kayock's Study V2C.1.1 — Reader, Narration, and External Catalog Regression",
        "result": "verified",
        ...
        "safety": {
            ...
            "local_narration_allowed": True,
            "external_tts_library_added": False,
