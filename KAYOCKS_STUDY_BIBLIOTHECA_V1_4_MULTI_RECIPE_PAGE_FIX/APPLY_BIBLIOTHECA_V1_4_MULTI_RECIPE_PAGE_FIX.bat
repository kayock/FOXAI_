...
title Kayock's Study - Bibliotheca V1.4 Multi-Recipe Page Fix

for %%I in ("%~dp0..") do set "FOXAI_ROOT=%%~fI"
set "PYTHON=%FOXAI_ROOT%\Runtime\Desktop\python\python.exe"
set "SCRIPT=%~dp0apply_bibliotheca_v1_4_multi_recipe_page_fix.py"

echo ==================================================================
echo KAYOCK'S STUDY - THE BIBLIOTHECA V1.4
echo MULTI-RECIPE PAGE GROUNDING FIX
echo ==================================================================
echo.
...
echo   - recovers recipe titles merged or split by PDF extraction
echo   - withholds ingredient-only matches for named cooking questions
...
choice /C YN /N /M "Apply Bibliotheca V1.4 multi-recipe page fix? [Y/N]: "
if errorlevel 2 (
