...
SERVER = (ROOT / "candidate" / "core" / "server.py").read_text(encoding="utf-8")
WEB = (ROOT / "candidate" / "core" / "foxai_web.py").read_text(encoding="utf-8")
UI = (ROOT / "candidate" / "ui" / "main_window.py").read_text(encoding="utf-8")
