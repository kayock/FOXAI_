...
R2 identifies the two root shortcuts by their exact BAT targets, so renaming a shortcut or changing its USB-owned icon filename does not cause a false failure.
...
Extract PDR3B_R2 directly into:

  Z:\FOXAI\PDR3B\

First run:

  Z:\FOXAI\PDR3B_R2\VERIFY_PACKAGE.bat
...
Then run:
  ...
  Z:\FOXAI\PDR3B_R2\RUN_EXACT_DESIGN.bat
